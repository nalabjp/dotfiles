...
DOTS_DIR=.dotfiles
# basic dot files
BASIC_DOTS=(.zshrc .gemrc .pryrc .rspec .tmux.conf .tmuxinator .vimrc .gvimrc .ideavimrc .vim/colors .vim/conf.d .gitconfig .gitignore .gitscript .bundle .tigrc .colordiffrc .rbenv/default-gems)
# backup dir
