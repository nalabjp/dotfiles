...
DOTS_DIR=.dotfiles
# basic dot files
BASIC_DOTS=(.zprofile .zshenv .zshrc .gemrc .pryrc .rspec .tmux.conf .vimrc .gvimrc .gitconfig .gitignore .gitscript .commit_template .bundle .tigrc .colordiffrc .rbenv/default-gems .rbenv/plugins)
# backup dir
